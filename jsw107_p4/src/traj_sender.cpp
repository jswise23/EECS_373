...
int main(int argc, char** argv) 
{
    ...
    for (int i=0;i<3;i++) //send this twice, just to make sure have communication w/ subscriber
    {
     ...
     //next trajectory:
    trajectory_point1.time_from_start = ros::Duration(1.0); //3 seconds to arrive, from previous point
    trajectory_point2.time_from_start = ros::Duration(2.0); //2 seconds to arrive, from previous point
    trajectory_point3.time_from_start = ros::Duration(3.0); //2 seconds to arrive, from previous point
    trajectory_point4.time_from_start = ros::Duration(4.0); //2 seconds to arrive, from previous point
    trajectory_point5.time_from_start = ros::Duration(6.0); //2 seconds to arrive, from previous point
    trajectory_point6.time_from_start = ros::Duration(8.0); //2 seconds to arrive, from previous point  
     new_trajectory.header.stamp = ros::Time::now();
    
     trajectory_point1.positions[0] = M_PI/2;
     trajectory_point1.positions[1] = 0.0;
     trajectory_point1.positions[2] = (3*M_PI)/2;
     
     trajectory_point2.positions[0] = M_PI;
     trajectory_point2.positions[1] = M_PI/4;
     trajectory_point2.positions[2] = 0.0;
     
     trajectory_point3.positions[0] = (3*M_PI)/2;
     trajectory_point3.positions[1] = M_PI/2;
     trajectory_point3.positions[2] = (3*M_PI)/2;
     
     trajectory_point4.positions[0] = 0.0;
     trajectory_point4.positions[1] = M_PI/4;
     trajectory_point4.positions[2] = 0.0;
     
     trajectory_point5.positions[0] = M_PI/2;
     trajectory_point5.positions[1] = 0.0;
     trajectory_point5.positions[2] = (3*M_PI)/2;
     
     trajectory_point6.positions[0] = M_PI;
     trajectory_point6.positions[1] = M_PI/4;
     trajectory_point6.positions[2] = 0.0;    

...
void ImageConverter::imageCb(const sensor_msgs::ImageConstPtr& msg){
        ...
        double xcam = 0.0029512*(i_centroid - 320);   //x coordinate relative to camera
        double ycam = 0.0029512*(j_centroid - 240);   //y coordinate relative to camera

        block_pose_.pose.position.x = 0.9788*xcam - 0.205*ycam + 0.545;
        block_pose_.pose.position.y = -1 * (0.9788*ycam + 0.205*xcam - 0.317);
        double theta = -0.2066; //angle of quarternion
